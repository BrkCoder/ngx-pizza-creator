    ...
    <form (ngSubmit)="onSubmit($event)" [formGroup]="parent">
      ...
      <div class="section" formGroupName="details">
        <div class="input">
          ...
          <input formControlName="name" id="name-input" type="text" placeholder="John Smith">
        </div>
        <div class="input">
          <label>
          ...
          <input formControlName="email" id="email-input" type="email" placeholder="Enter your email">
        </div>
        <div class="input">
          <label>
          ...
          <input formControlName="confirm" id="verify-email-input" type="email" placeholder="Confirm your email">
        </div>
      </div>
      <div class="section" formGroupName="details">
        <div class="input">
          ...
          <input formControlName="address" id="address-input" type="text" placeholder="44 Pizza Street">
        </div>
        <div class="input">
          <label>
          ...
          <input formControlName="postcode" id="postcode-input" type="text" placeholder="PI3 3AS">
        </div>
        <div class="input">
          <label>
          ...
          <input formControlName="phone" id="phone-input" type="text" placeholder="01234 567 890">
        </div>
      </div>
